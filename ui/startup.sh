...
echo "NEXT_PUBLIC_NOTIFICATIONS_ENABLED: $NEXT_PUBLIC_NOTIFICATIONS_ENABLED"
echo "NEXT_PUBLIC_SCHEMA_REGISTRY_ENABLED: $NEXT_PUBLIC_SCHEMA_REGISTRY_ENABLED"
echo "NEXT_PUBLIC_NOTIFICATIONS_URL: $NEXT_PUBLIC_NOTIFICATIONS_URL"
...
export NEXT_PUBLIC_NOTIFICATIONS_ENABLED=${NEXT_PUBLIC_NOTIFICATIONS_ENABLED:-false}
export NEXT_PUBLIC_SCHEMA_REGISTRY_ENABLED=${NEXT_PUBLIC_SCHEMA_REGISTRY_ENABLED:-false}
export NEXT_PUBLIC_NOTIFICATIONS_URL=${NEXT_PUBLIC_NOTIFICATIONS_URL:-http://notifier:8082}
...
echo "  NEXT_PUBLIC_NOTIFICATIONS_ENABLED: \"$NEXT_PUBLIC_NOTIFICATIONS_ENABLED\"," >> /app/public/env.js
echo "  NEXT_PUBLIC_SCHEMA_REGISTRY_ENABLED: \"$NEXT_PUBLIC_SCHEMA_REGISTRY_ENABLED\"," >> /app/public/env.js
echo "  NEXT_PUBLIC_NOTIFICATIONS_URL: \"$NEXT_PUBLIC_NOTIFICATIONS_URL\"," >> /app/public/env.js
