...
echo "NEXT_PUBLIC_USE_SSE_STATUS: $NEXT_PUBLIC_USE_SSE_STATUS"
...
export NEXT_PUBLIC_USE_SSE_STATUS=${NEXT_PUBLIC_USE_SSE_STATUS:-false}
...
echo "  NEXT_PUBLIC_USE_SSE_STATUS: \"$NEXT_PUBLIC_USE_SSE_STATUS\"," >> /app/public/env.js
