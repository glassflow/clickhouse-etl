      ...
      <div className="flex items-center gap-3">
        <div className="flex flex-col gap-1">
          ...
          <p className="body-3 text-[var(--text-secondary)]">
            Monitor pipeline metrics, logs, and health across your data infrastructure
          </p>
        </div>
      ...
      <div className="flex flex-col items-center justify-center min-h-[50vh] gap-6">
        <Card variant="dark" className="flex flex-col items-center gap-5 p-12 max-w-md w-full text-center">
          <span className="text-[var(--color-foreground-primary)]" aria-hidden="true">
            <ActivityIcon size={48} strokeWidth={1.25} />
          </span>
          <div className="flex flex-col gap-2">
            <h2 className="title-4 text-[var(--text-primary)]">Observability is coming soon</h2>
            <p className="body-3 text-[var(--text-secondary)]">
              Unified metrics, trace correlation, and alerting for all your pipelines — in one
              place.
            </p>
          </div>
