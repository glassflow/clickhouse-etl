...
describe('V3NextPipelineAdapter', () => {
  const adapter = new V3NextPipelineAdapter()
  ...
  describe('factory', () => {
    it('getPipelineAdapter returns V3Next adapter for "v3-next"', () => {
      expect(getPipelineAdapter('v3-next').version).toBe(PipelineVersion.V3_NEXT)
    })

    it('getPipelineAdapter still returns V3 adapter for "v3"', () => {
