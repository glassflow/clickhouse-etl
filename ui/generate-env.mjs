...
const envVars = {
  ...
  NEXT_PUBLIC_FILTERS_ENABLED: process.env.NEXT_PUBLIC_FILTERS_ENABLED || 'false',
  NEXT_PUBLIC_TRANSFORMATIONS_ENABLED: process.env.NEXT_PUBLIC_TRANSFORMATIONS_ENABLED || 'false',
  NEXT_PUBLIC_NOTIFICATIONS_ENABLED: process.env.NEXT_PUBLIC_NOTIFICATIONS_ENABLED || 'false',
  NEXT_PUBLIC_USE_SSE_STATUS: process.env.NEXT_PUBLIC_USE_SSE_STATUS || 'false',
}
...
const envJsContent = `window.__ENV__ = {
  ...
  NEXT_PUBLIC_USE_SSE_STATUS: "${envVars.NEXT_PUBLIC_USE_SSE_STATUS}"
};`
