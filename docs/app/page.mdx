...
<Cards>
    <Cards.Card icon={<TerminalIcon />} title="Installation" href="/installation" />
    <Cards.Card icon={<MenuIcon />} title="Usage Guide" href="/pipeline/usage" />
    <Cards.Card icon={<GitHubTipIcon />} title="Local Testing" href="/local-testing" />
</Cards>
