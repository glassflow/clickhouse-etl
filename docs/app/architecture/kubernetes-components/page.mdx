...
### 12. Deduplicator Deployment
- **Deployment Name**: `dedup-{partition-id}`
- **Purpose**: Deduplicates data
- **Features**:
  - Single replica
  - Uses BadgerDB for deduplication in disk and memory

### 13. Sink Deployment
- **Deployment Name**: `sink-{partition-id}`
