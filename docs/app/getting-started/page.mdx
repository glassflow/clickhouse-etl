...
- **Source**: Data sources to consume from (e.g., [Kafka topics](/sources/kafka), [OTLP receivers](/sources/otlp))
...
- [Run a demo pipeline](/getting-started/demo)
  This will spin up a local Kafka, GlassFlow and ClickHouse instance and run a demo pipeline.
