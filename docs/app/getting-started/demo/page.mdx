...
Install the GlassFlow CLI so you can run the demo. You need **Docker** (or compatible runtime) and **kubectl** (installed automatically via Homebrew if you use the recommended install).
