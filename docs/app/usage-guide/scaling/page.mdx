...
| --- | --- | --- |
| **Ingestor** (base / left / right) | Yes | Increase replicas to consume from more Kafka partitions in parallel. |
...
- **Ingestor, transform, and sink** can be scaled via `pipeline_resources` in the pipeline configuration.
