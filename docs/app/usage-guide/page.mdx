...
Once your pipeline is running, you can scale the ingestor, transform, and sink components to increase throughput. See [Scaling Pipelines](/usage-guide/scaling) for how to configure replicas and best practices.
