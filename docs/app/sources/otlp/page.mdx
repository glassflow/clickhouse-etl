...
Any OTLP-capable client can talk to the GlassFlow OTLP receiver. The pages below cover the validated integrations for popular telemetry agents and forwarders — tested configs, field mappings, and per-tool caveats.
