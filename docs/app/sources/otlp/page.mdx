...
Set `source.type` to one of the OTLP signal types in the pipeline configuration:
...
- [Examples](/sources/otlp/examples) -- quick start and full pipeline examples
...
- [ClickHouse Tables](/sources/otlp/clickhouse-tables) -- recommended CREATE TABLE statements
