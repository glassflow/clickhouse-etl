...
- **No official Elastic OTLP output plugin** exists. Elastic's [own guidance](https://www.elastic.co/observability-labs/blog/logstash-to-otel) suggests migrating Logstash pipelines to the OpenTelemetry Collector.
