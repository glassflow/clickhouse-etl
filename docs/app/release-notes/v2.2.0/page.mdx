...
sidebarTitle: v2.2.0
icon: FileIcon
description: Release notes for the GlassFlow ClickHouse ETL v2.2.0.
---
...
For logs, simply turn on logs from the values file and set your OTEL collector information in the `values.yaml`. GlassFlow will send OTEL logs to your collector, which you can then ingest into your favorite OTEL backend for centralized log management and analysis.

> 💡 **Setup Guide**: For detailed OTEL configuration and setup instructions, see our [Observability Setup Guide](/installation/kubernetes/observability) (coming soon).
...
![UI Metrics](/assets/ui_pipeline_metrics.jpg)
...
For a complete list of all changes, improvements, and bug fixes in v2.2.0, see our [GitHub release 2.1.3](https://github.com/glassflow/clickhouse-etl/releases/tag/v2.1.3) and [GitHub release 2.2.0](https://github.com/glassflow/clickhouse-etl/releases/tag/v2.2.0) 
