...
> 💡 **Setup Guide**: For detailed OTEL configuration and setup instructions, see our [Observability Setup Guide](/installation/kubernetes/observability).
...
For a complete list of all changes, improvements, and bug fixes in v2.2.0, see our [GitHub release v2.1.3](https://github.com/glassflow/clickhouse-etl/releases/tag/v2.1.3) and [GitHub release v2.2.0](https://github.com/glassflow/clickhouse-etl/releases/tag/v2.2.0) 
