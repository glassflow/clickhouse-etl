...
For a complete list of all changes, improvements, and bug fixes in v2.4.0, see our [GitHub release v2.3.0](https://github.com/glassflow/clickhouse-etl/releases/tag/v2.3.0) and [GitHub release v2.4.0](https://github.com/glassflow/clickhouse-etl/releases/tag/v2.4.0).
