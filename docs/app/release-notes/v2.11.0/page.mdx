...
2. **Configure pipeline resources** — Use the API or pipeline JSON to set replicas for ingestor, transform, or sink; see the [Scaling Guide](/installation/kubernetes/scaling) for best practices.
...
6. **Read the Scaling Guide** — Check [Scaling Guide](/installation/kubernetes/scaling) for what can be scaled and how to configure it.
