...
- **Pipeline JSON and reference** — Pipeline resources are now fully configurable directly within your pipeline JSON. For a complete list of supported fields and syntax, refer to our updated [Pipeline Configuration Reference](/configuration/pipeline-config-reference#pipeline-resources-configuration).
...
- **New helper functions** — [`floor`](/transformations/stateless-transformation#floor), [`ceil`](/transformations/stateless-transformation#ceil), and [`round`](/transformations/stateless-transformation#round) added as custom expression functions for numeric rounding.
