...
Glasflow is now supporting **Nested JSON.** It allows you to seamlessly ingest, flatten and process complex Kafka event payloads that mirror messy real-world data. Feel free to check out our example [here](/configuration/data-format#nested-json-support).
