...
- **NATS batch operations** - New batch read/write implementation for NATS improving throughput and efficiency
- **Badger deduplication** - New Badger-based deduplication implementation for better performance and reliability in duplicate detection
- **Schema management** - Schema separated as an independent entity with improved validation and handling of empty column mappings
...
- **Pipeline JSON improvements** - Refactored pipeline JSON to model method for better maintainability
- **Ingress setup documentation** - New ingress setup page for Kubernetes deployments
- **Updated Helm values** - Helm values updated with latest changes for easier deployment
