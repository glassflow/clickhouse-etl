...
> 💡 **Learn More**: For detailed information on configuring stateless transformations, see the [Stateless Transformations](/transformations/stateless-transformation) documentation.
...
5. **Review the documentation** - See the [Stateless Transformations](/transformations/stateless-transformation) guide for examples and the [Python SDK](/usage-guide/python-sdk) documentation for programmatic pipeline creation
