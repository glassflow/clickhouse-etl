...
- **Migration script improvements** - Enhanced migration script with better error handling and validation
- **CI/CD integration** - Migration container can be built and deployed as part of CI/CD pipelines
...
> 💡 **Note**: Usage statistics collection is enabled by default.
...
> 💡 **Reference**: For complete Helm chart configuration options, see the [GlassFlow Helm Charts repository](https://github.com/glassflow/charts/tree/main) and the [Helm Values Configuration](/installation/kubernetes/helm-values) documentation.
