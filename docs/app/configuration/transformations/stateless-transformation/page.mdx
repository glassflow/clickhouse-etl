...
<Tabs items={['Web UI', 'Pipeline JSON']} defaultIndex="0" storageKey="client_preference">
  <Tabs.Tab>
    <img alt="Stateless Transformation Configuration" src="/assets/ui_stateless_transformation_configuration.png" />
  </Tabs.Tab>
  <Tabs.Tab>
    ```json
    {
    ...
    ```
    Refer to the [Pipeline JSON Reference](/configuration/pipeline-json-reference#stateless-transformation-configuration) for more details.
  </Tabs.Tab>
</Tabs>
