...
|-------|------|----------|-------------|
| `version` | string | Yes | Version of the pipeline configuration. Current supported version is "2.0.0". |
...
| `schema` | object | No | Configuration for the schema of the pipeline. See [Schema Configuration](#schema-configuration). |
