...
| `pipeline_resources` | object | No | Configuration for the kubernetes resources for the pipeline. See [Pipeline Resources Configuration](#pipeline-resources-configuration). |
...
> 💡 **Note**: For comprehensive type mapping information, see the [Supported Data Formats](/configuration/data-format) documentation.
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `ingestor` | object | No | Ingestor resources configuration. See [Ingestor Resources Configuration](#ingestor-resources-configuration). |
| `join` | object | No | Join resources configuration. See [Join Resources Configuration](#join-resources-configuration). |
| `sink` | object | No | Sink resources configuration. See [Sink Resources Configuration](#sink-resources-configuration). |
| `transform` | object | No | Transform resources configuration. See [Transform Resources Configuration](#transform-resources-configuration). |
| `nats` | object | No | Nats resources configuration. See [Nats Resources Configuration](#nats-resources-configuration). |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `base` | object | No | Base ingestor resources configuration. See [Base Ingestor Resources Configuration](#base-ingestor-resources-configuration). |
| `left` | object | No | Left ingestor resources configuration. See [Left Ingestor Resources Configuration](#left-ingestor-resources-configuration). |
| `right` | object | No | Right ingestor resources configuration. See [Right Ingestor Resources Configuration](#right-ingestor-resources-configuration). |
...
| `requests` | object | No | Requests resources configuration. See [Requests Resources Configuration](#requests-resources-configuration). |
| `limits` | object | No | Limits resources configuration. See [Limits Resources Configuration](#limits-resources-configuration). |
...
| `requests` | object | No | Requests resources configuration. See [Requests Resources Configuration](#requests-resources-configuration). |
| `limits` | object | No | Limits resources configuration. See [Limits Resources Configuration](#limits-resources-configuration). |
| `storage` | object | No | Storage resources configuration, only used when deduplication is enabled. See [Storage Resources Configuration](#storage-resources-configuration). |

#### Storage Resources Configuration

| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `size` | string | No | Size of the storage. Defaults to "10Gi". This parameter is immutable and cannot be changed after the pipeline is created. |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `stream` | object | No | Stream resources configuration. See [Stream Resources Configuration](#stream-resources-configuration). |
...
| `max_bytes` | string | No | Maximum bytes of the stream. Defaults to "0 bytes" which will not limit the stream size. This parameter is immutable and cannot be changed after the pipeline is created. |
