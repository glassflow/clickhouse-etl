...
<Callout type="info">
Running the Enterprise Edition? Avro and Protobuf source formats, Confluent Schema Registry, and the unified `schema` object are documented in the [Pipeline Configuration Reference (Enterprise)](/configuration/pipeline-config-reference-enterprise).
</Callout>
