...
2. │      124 │     457 │ Jane Smith │ jane@example.com │ 2024-03-20 10:03:00 │ ["tag13", "tag324"] │
   └──────────┴─────────┴────────────┴──────────────────┴─────────────────────┴─────────────────────┘
```
To start creating your own pipelines with the UI, you can follow the [pipeline/usage/web-ui](/pipeline/usage/web-ui) guide.
...
To start creating your own pipelines with the python SDK, you can follow the [pipeline/usage/python-sdk](/pipeline/usage/python-sdk) guide.
