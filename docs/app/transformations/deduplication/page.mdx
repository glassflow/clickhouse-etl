    ...
    transforms:
      - type: dedup
        ...
        config:
          ...
          time_window: 24h
    ```
    Refer to the [Pipeline Configuration Reference](/configuration/pipeline-config-reference#deduplication) for more details.
  </Tabs.Tab>
  <Tabs.Tab>
    ```json
    {
...
- [Pipeline Configuration Reference - Deduplication Configuration](/configuration/pipeline-config-reference#deduplication)
