...
For more details on how deduplication handles failures, see the [Data Flow](/architecture/data-flow#stage-3-transformations-optional) documentation.

## Configuration

Deduplication is configured per source in the pipeline configuration. Here's the configuration structure:
...
- [Data Flow - Deduplication Stage](/architecture/data-flow#stage-3-transformations-optional)
