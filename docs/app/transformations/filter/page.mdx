...
<Tabs items={['YAML', 'JSON', 'Web UI']} defaultIndex="2" storageKey="config_format">
  <Tabs.Tab>
    ...
    ```
    Refer to the [Pipeline Configuration Reference](/configuration/pipeline-config-reference#filter) for more details.
  </Tabs.Tab>
  <Tabs.Tab>
    ```json
    {
...
- [Pipeline Configuration Reference - Filter Configuration](/configuration/pipeline-config-reference#filter)
