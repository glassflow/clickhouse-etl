...
3. Access the web interface at `http://localhost:8080` to configure the pipeline. For detailed instructions on setting up your first pipeline, see the [Usage Guide](/usage).

For details about the Docker components that are running, see the [System Components](/architecture/system_components) page.
