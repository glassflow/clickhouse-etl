...
The easiest way to get started is to use Docker. This will give you a local environment that you can use to create a pipeline and test the functionality.
...
### [GCP with Pulumi](/installation/self-host/gcp-pulumi)

To run GlassFlow in your GCP account, use our Pulumi infrastructure as code project. This will deploy GlassFlow on GKE with all necessary infrastructure components.