...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Run deduplication pipeline with configurable parameters')
    parser.add_argument('--num-records', type=int, default=10000,
                      help='Number of records to generate (default: 10000)')
    parser.add_argument('--duplication-rate', type=float, default=0.1,
                      help='Rate of duplication (default: 0.1)')
    parser.add_argument('--rps', type=int, default=1000,
                      help='Records per second (default: 1000)')
    parser.add_argument('--config', type=str, default='config/glassflow/deduplication_pipeline.json',
                      help='Path to pipeline configuration file (default: config/glassflow/deduplication_pipeline.json)')
    parser.add_argument('--generator-schema', type=str, default='config/glassgen/user_event.json',
    ...
    main(args.num_records, args.duplication_rate, args.rps, args.config, args.generator_schema, args.yes, args.cleanup)
