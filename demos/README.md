...
- **[Programmatically Using Python Demos](https://docs.glassflow.dev/local-testing#option-2-programmatically-using-python-demos)**: Use our Python SDK to automate the pipeline setup and generate events
