...
func TestConvertValue(t *testing.T) {
	tests := []struct {
		...
		// Test DateTime64 with basic types
		{
			name:       "int to DateTime64",
		...
		// Test LowCardinality(DateTime) with basic types
		{
