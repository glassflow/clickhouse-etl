...
func TestExtractEventValue(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			dataType: internal.KafkaTypeString,
			input:    "test",
			want:     "test",
			wantErr:  false,
		},
		{
			...
			dataType: internal.KafkaTypeBool,
			input:    true,
			want:     true,
			wantErr:  false,
		},
		{
			name:     "int conversion",
			dataType: internal.KafkaTypeInt,
			input:    42,
			want:     int64(42),
			wantErr:  false,
		},
		{
			...
			dataType: internal.KafkaTypeInt8,
			input:    int8(8),
			want:     int8(8),
			wantErr:  false,
		},
		{
			...
			dataType: internal.KafkaTypeInt16,
			input:    int16(16),
			want:     int16(16),
			wantErr:  false,
		},
		{
			...
			dataType: internal.KafkaTypeInt32,
			input:    int32(32),
			want:     int32(32),
			wantErr:  false,
		},
		{
			...
			dataType: internal.KafkaTypeInt64,
			input:    int64(64),
			want:     int64(64),
			wantErr:  false,
		},
		{
			...
			dataType: internal.KafkaTypeUint,
			input:    uint(42),
			want:     uint64(42),
			wantErr:  false,
		},
		{
			...
			dataType: internal.KafkaTypeUint8,
			input:    uint8(8),
			want:     uint8(8),
			wantErr:  false,
		},
		{
			...
			dataType: internal.KafkaTypeUint16,
			input:    uint16(16),
			want:     uint16(16),
			wantErr:  false,
		},
		{
			...
			dataType: internal.KafkaTypeUint32,
			input:    uint32(32),
			want:     uint32(32),
			wantErr:  false,
		},
		{
			...
			dataType: internal.KafkaTypeUint64,
			input:    uint64(64),
			want:     uint64(64),
			wantErr:  false,
		},
		{
			...
			dataType: internal.KafkaTypeFloat,
			input:    3.14,
			want:     3.14,
			wantErr:  false,
		},
		{
			...
			dataType: internal.KafkaTypeFloat32,
			input:    float32(3.14),
			want:     float32(3.14),
			wantErr:  false,
		},
		{
			...
			dataType: internal.KafkaTypeFloat64,
			input:    float64(3.14),
			want:     float64(3.14),
			wantErr:  false,
		},
		...
		},
		{
			...
			dataType: internal.KafkaTypeArray,
		...
		{
			name:     "map of strings",
			dataType: internal.KafkaTypeMap,
			input:    map[string]any{"key1": "value1", "key2": "value2"},
			want:     map[string]any{"key1": "value1", "key2": "value2"},
			wantErr:  false,
		},
		{
			name:     "map of mixed types",
			dataType: internal.KafkaTypeMap,
			input:    map[string]any{"string": "value", "number": 42, "bool": true},
			want:     map[string]any{"string": "value", "number": 42, "bool": true},
			wantErr:  false,
		},
		{
			name:     "empty map",
...
func TestConvertValue(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			columnType: internal.CHTypeString,
		...
		{
			name:       "bool to Bool",
			columnType: internal.CHTypeBool,
			fieldType:  internal.KafkaTypeBool,
			input:      true,
			want:       true,
			wantErr:    false,
		},
		{
			...
			fieldType:  internal.KafkaTypeInt8,
			input:      int8(8),
			want:       int8(8),
			wantErr:    false,
		},
		...
		},
		{
			...
			fieldType:  internal.KafkaTypeInt16,
			input:      int16(16),
			want:       int16(16),
			wantErr:    false,
		},
		{
			...
			fieldType:  internal.KafkaTypeInt32,
			input:      int32(32),
			want:       int32(32),
			wantErr:    false,
		},
		...
		},
		{
			...
			fieldType:  internal.KafkaTypeUint8,
			input:      uint8(8),
			want:       uint8(8),
			wantErr:    false,
		},
		...
		},
		{
			...
			columnType: internal.CHTypeUInt64,
			fieldType:  internal.KafkaTypeUint64,
			input:      uint64(64),
			want:       uint64(64),
			wantErr:    false,
		},
		{
			...
			columnType: internal.CHTypeFloat32,
			fieldType:  internal.KafkaTypeFloat32,
			input:      float32(3.14),
			want:       float32(3.14),
			wantErr:    false,
		},
		{
			...
			columnType: internal.CHTypeFloat64,
			fieldType:  internal.KafkaTypeFloat64,
			input:      float64(3.14),
			want:       float64(3.14),
			wantErr:    false,
		},
		{
			...
			columnType: internal.CHTypeEnum8,
			fieldType:  internal.KafkaTypeString,
			input:      "value",
			want:       "value",
			wantErr:    false,
		...
		{
			name:       "string to UUID",
			columnType: internal.CHTypeUUID,
			fieldType:  internal.KafkaTypeString,
		...
		},
		{
			...
			columnType: internal.CHTypeDateTime,
			fieldType:  internal.KafkaTypeInt64,
		...
		// Test all integer types to DateTime
		{
			name:       "int to DateTime",
			columnType: internal.CHTypeDateTime,
			fieldType:  internal.KafkaTypeInt,
			input:      1609459200,
			want:       time.Unix(1609459200, 0),
		...
		{
			name:       "int32 to DateTime",
			columnType: internal.CHTypeDateTime,
			fieldType:  internal.KafkaTypeInt32,
			input:      int32(1609459200),
			want:       time.Unix(1609459200, 0),
			wantErr:    false,
		},
		// Test all float types to DateTime
		{
			name:       "float to DateTime",
			columnType: internal.CHTypeDateTime,
			fieldType:  internal.KafkaTypeFloat,
			input:      float64(1609459200.5),
			want:       time.Unix(1609459200, 500000000),
			wantErr:    false,
		},
		{
			name:       "float32 to DateTime",
			columnType: internal.CHTypeDateTime,
			fieldType:  internal.KafkaTypeFloat32,
			input:      float32(1609459200.0),
			want:       time.Unix(1609459200, 0),
			wantErr:    false,
		},
		// Test DateTime64 with various types
		{
			name:       "int64 to DateTime64",
			columnType: internal.CHTypeDateTime64,
			fieldType:  internal.KafkaTypeInt64,
		...
		// Test LowCardinality(DateTime) with various types
		{
			...
			columnType: internal.CHTypeLCDateTime,
			fieldType:  internal.KafkaTypeInt64,
			input:      int64(1609459200),
			want:       time.Unix(1609459200, 0),
			wantErr:    false,
		...
		// Test invalid types for DateTime
		{
			name:       "bool to DateTime should fail",
			columnType: internal.CHTypeDateTime,
			fieldType:  internal.KafkaTypeBool,
			input:      true,
			want:       nil,
		...
		{
			name:       "Map(String, String) with map data",
		...
		{
			name:       "Map(LowCardinality(String), String) with map data",
		...
		{
			name:       "Map(String, String) with map[string]interface{}",
			columnType: "Map(String, String)",
			fieldType:  internal.KafkaTypeMap,
		...
		{
			name:       "Map(String, String) with non-map data",
			columnType: "Map(String, String)",
			fieldType:  internal.KafkaTypeString,
			input:      "not a map",
			want:       nil,
		...
		{
			name:       "Array(Map(String, String)) with array of maps",
		...
		{
			name:       "Array(Map(LowCardinality(String), String)) with array of maps",
		...
		{
			name:       "Array(Map(String, String)) with mixed array elements",
			columnType: "Array(Map(String, String))",
			fieldType:  internal.KafkaTypeArray,
