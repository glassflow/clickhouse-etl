...
// Source: github.com/glassflow/clickhouse-etl-internal/glassflow-api/internal/schemav2 (interfaces: DBClient)
//
...
func (m *MockDBClient) GetMappingsBySchema(ctx context.Context, sourceID, schemaID string, orientation models.MappingOrintation) ([]*models.SchemaMapping, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMappingsBySchema", ctx, sourceID, schemaID, orientation)
	ret0, _ := ret[0].([]*models.SchemaMapping)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockDBClient) SaveSchemaVersion(ctx context.Context, schemaVersion models.SchemaVersion, sourceMappings, destinationMappings []*models.SchemaMapping) error {
	m.ctrl.T.Helper()
